            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] == "ID #: c4")
                {
                    ...
                    do
                    {
                        ...
                        validAge = int.TryParse(ageInput, out ageI);
                    } while (!validAge);



                    ourAnimals[i, 2] = ageI.ToString();
                    string? physicalDesc;
                    do
                    {
                        Console.WriteLine("Enter a physical description for ID #: (size, color, breed, gender, weight, housebroken)");
                        physicalDesc = Console.ReadLine();
                        //physicalDesc = inp.ToString();
                        if (physicalDesc != null)
                        {
                            ourAnimals[i, 4] = physicalDesc;
                        }
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] == "ID #: c4")
                {
                    ...
                    do{
                        ...
                        if (pers != null && pers != "")
                        {
                            vaildPersonailty = true;
                            ourAnimals[i, 5] = pers.ToString();
                        }
                    }while(!vaildPersonailty);
